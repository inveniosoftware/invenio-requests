...
class RequestEventsEndpointLink(EndpointLink):
    """Render links for RequestEvent API *without* comment/event.

    This is needed because
    a) Request uses RequestEvent endpoints without comment/event in its links
    b) RequestEvent uses <request_id> + <comment_id> in route/arg. parsing
       but
       Request uses <id> in their route/arg. parsing
    """
...
class RequestEventEndpointLink(EndpointLink):
    """Render links for RequestEvent API *with* comment/event."""
