...
const replyMapDispatchToProps = {};

const replyMapStateToProps = (state) => ({});

export const TimelineReplyCommentEditor = connect(
  replyMapStateToProps,
  replyMapDispatchToProps
)(TimelineCommentEditorComponent);
