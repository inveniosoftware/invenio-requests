...
def test_delete_child_comment_preserves_parent_child(
    ...
    assert deleted_child["type"] == CommentEventType.type_id
    ...
    assert child_types == {CommentEventType.type_id}
    ...
    assert deleted_child_in_array["type"] == CommentEventType.type_id
